function transformations=IRB940_Serial_Structure(handles)
    %Inputs
    ...
    %Transformations 
        ...
        A3=makehgtform('translate',[0, 0, sq3]);
...
%             disp(T3b);
        ...
        %Tool Transformation
        Atool=makehgtform('translate',tool_off);%*makehgtform('yrotate',(pi/2))*makehgtform('Zrotate',pi);
...
%             disp(A4*A5*A6*Atool);
        ...
        transformations.base.stl=correct;
        ...
        transformations.tool.stl=Ttoolb*scale;
